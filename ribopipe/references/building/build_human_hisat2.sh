...
mkdir $LOCATION/human_reference_
cd $LOCATION/human_reference_hisat2
mkdir $LOCATION/human_reference_hisat2/source_files
cd $LOCATION/human_reference_hisat2/source_files
...
#Build
mkdir genome
hisat2-build source_files/*dna.chromosome.*.fa genome/genome

mkdir ncrna
hisat2-build source_files/Homo_sapiens.GRCh38.ncrna.fa ncrna/ncrna
