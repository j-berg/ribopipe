...
=====================================================================
:data:`ribopipe` is toolkit designed for automating the assembly,
...
**RiboPipe** is developed by Jordan Berg @ `University of Utah
<http://www.utah.edu/>`, along with other collaborators.

========
Tutorial
========
Video walkthrough coming soon!
See the `Quickstart <content/quickstart>` guide for more information.
