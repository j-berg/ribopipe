...
df = pd.read_csv("./transcripts.gtf", sep="\t", header=None, comment='#')
...
df_coding.to_csv("./transcripts_coding.gtf",sep="\t",header=None, index=False, quoting=csv.QUOTE_NONE)
...
df1.to_csv("transcripts_truncated.gtf",sep="\t",header=None, index=False, quoting=csv.QUOTE_NONE)
